...
export default () => {
    ...
    return (
        ...
        <div className=""  style={{ display: 'flex', justifyContent: 'center', alignItems:'center' , flexDirection:'column' , color:'#eeeeee' }}>
          <section className="">
          <h3 className="mb-5 text-left">{productItemValues.productItemName}</h3>
          <p className="mb-3" style={{textAlign:'left' , fontSize:'1.2rem' , fontWeight:'bold' }}>Pickup Station : <span style={{fontWeight:'normal' , marginLeft:'.5rem'}}>{` ${bookingValues.pickupStation}`}</span></p>
          <p className="mb-3" style={{textAlign:'left' , fontSize:'1.2rem' , fontWeight:'bold'}}>Return Station : <span style={{fontWeight:'normal' , marginLeft:'.5rem'}}>{` ${bookingValues.returnStation}`}</span></p>
          
          <p className="mb-3" style={{textAlign:'left' , fontSize:'1.2rem' , fontWeight:'bold' }}>Pickup Date : <span style={{fontWeight:'normal' , marginLeft:'.5rem'}}>{` ${bookingValues.dates[0]}`}</span></p>
          <p className="mb-3" style={{textAlign:'left' , fontSize:'1.2rem' , fontWeight:'bold'}}>Return Date : <span style={{fontWeight:'normal' , marginLeft:'.5rem'}}>{` ${bookingValues.dates[1]}`}</span></p>
